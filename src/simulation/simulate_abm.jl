...
function _expand_split_cells_abm(model::ResPop_ABM, exp::ExperimentParams, n_rep::Int64;
    ...
    expansion_model = ResPop_ABM(_copy_model_params(model.params; al = 0.0, drug_effect = drug_effect);
                                 abm = model.abm)
...
function _simulate_experiment_abm(model::ResPop_ABM, exp::ExperimentParams; kwargs...)
    ...
    de = normalize_drug_effect(_kw(kwargs, :drug_effect, model.params.drug_effect))
