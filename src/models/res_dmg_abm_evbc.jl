...
"""Return the ResDmg phenotype label for a lineage-aware cell."""
...
"""Convert standard ResDmg ABM cells into lineage-aware EvBC cells."""
function _to_evbc_cells(cells::Vector{ResDmgCell}; t0::Float64 = 0.0)
    ...
    next_cell_id, lineage_records = initialize_lineage_state!(evbc_cells, _resdmg_pheno_label, t0)
