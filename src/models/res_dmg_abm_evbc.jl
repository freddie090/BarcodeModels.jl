...
function resdmg_damage_event!(cell_arr::Vector{ResDmgCellEvBC},
    cell_pos::Int64,
    phen_counts::ResDmgPhenoCounts)
...
function resdmg_repair_event!(cell_arr::Vector{ResDmgCellEvBC},
    cell_pos::Int64,
    phen_counts::ResDmgPhenoCounts)
...
function resdmg_death_event!(cell_arr::Vector{ResDmgCellEvBC},
    cell_pos::Int64,
    phen_counts::ResDmgPhenoCounts)
